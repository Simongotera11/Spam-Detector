package com.example.Spam.Detector.util;
...
public class SpamDetector {
    ...
    public  double calculateSpamProbability(String fileContent) {
        boolean flag= false;
    ...
    public ArrayList<TestFile> test(File mainDirectory) throws IOException {
        ...
        for(File file: testHam){
            double probFileIsSpam = probFileIsSpam(pathTrainHam,file);
            TestFile testFile=new TestFile(file.getName(), probFileIsSpam,"Ham");
